...
from .convolution_cls1 import ConvolutionModuleCLS as ConvCLS1
from .convolution_cls2 import ConvolutionModuleCLS as ConvCLS2
...
from .subsampling import Conv2dSubsampling2
from .subsampling import Conv2dSubsampling4
from .subsampling import Conv2dSubsampling6
from .subsampling import Conv2dSubsampling8
...
class ConformerEncoder(BaseEncoder):
    ...
    def __init__(
        ...
        if conv_type == "type1":
            convolution_layer = ConvCLS1
        elif conv_type == "type2":
            convolution_layer = ConvCLS2
        else:
